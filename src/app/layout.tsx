...
const RootLayout: FC<{ children: ReactNode }> = ({ children }) => {
  return (
    <html className={`${gothamUltra.variable} ${centuryGothic.variable}`} lang="en">
      {/* CookieYes - must load first before analytics scripts */}
      <Script
        id="cookieyes"
        src="https://cdn-cookieyes.com/client_data/aaed38509f0052113bc94fa97a711cc6/script.js"
      ...
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-T37T4F8C"
            height="0"
            width="0"
