  ...
  return isMobile ? (
    <>
      <HamburgerMenu ref={ref} data-is-open={isOpen} initial={{ opacity: 0, x: 20 }}>
        ...
        <ButtonLink
          data-is-active={pathname === '/orange-leaf/menu'}
          onClick={(): void => {
            onClose('/orange-leaf/menu');
          }}
        >
          Menu
        </ButtonLink>
        <NativeLink href="/orange-leaf/locations">Locations</NativeLink>
        <ButtonLink
          data-is-active={pathname === '/orange-leaf/e-club'}
          onClick={(): void => {
            onClose('/orange-leaf/e-club');
          }}
        >
          E-club
        </ButtonLink>
        <ButtonLink
          data-is-active={pathname === '/orange-leaf/gift-cards'}
          onClick={(): void => {
            onClose('/orange-leaf/gift-cards');
          }}
        >
          Gift cards
        </ButtonLink>
        <ButtonLink
          data-is-active={pathname === '/orange-leaf/about-us'}
          onClick={(): void => {
            onClose('/orange-leaf/about-us');
          }}
        >
          About us
        </ButtonLink>
    ...
    <OuterContainer>
      <MaxWidthWrapper>
        <Container>
          ...
          <LinkSection>
            <Link data-is-active={pathname === '/orange-leaf/menu'} href="/orange-leaf/menu">
              Menu
            </Link>
            <Link data-is-active={pathname === '/orange-leaf/e-club'} href="/orange-leaf/e-club">
              E-club
            </Link>
            <Link data-is-active={pathname === '/orange-leaf/gift-cards'} href="/orange-leaf/gift-cards">
              Gift cards
            </Link>
            <Link data-is-active={pathname === '/orange-leaf/about-us'} href="/orange-leaf/about-us">
              About us
            </Link>
          </LinkSection>
          <Section>
            <Link data-is-active={pathname === '/orange-leaf/franchising'} href="/orange-leaf/franchising">
              Franchising
            </Link>
            <Separator />
            <Link href="/orange-leaf/order">
